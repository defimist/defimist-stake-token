...
/// @dev Distributes Defimist Stake tokens.
contract Distribution is Ownable, IDistribution {
    ...
    /// @param _tokenAddress The address of the Defimist Stake token contract.
    /// @param _initialStakeAmount The sum of initial stakes made on Defimist chain before transitioning to POSDAO.
    ...
    /// @dev This method is called after the Defimist Stake tokens are transferred to this contract.
